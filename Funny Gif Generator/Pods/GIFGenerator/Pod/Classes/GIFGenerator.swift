...
@objc public class GifGenerator: NSObject {
     ...
     */
    public func generateGifFromImages(imagesArray imagesArray:[UIImage], repeatCount: Int = 100, frameDelay: NSTimeInterval, destinationURL: NSURL, callback:(data: NSData?, error: NSError?) -> ()) {
